...
public class Sender implements Runnable {
    ...
    void run(long now) {
        ...
        /**
         * 步骤二：根据已获取的元数据获取此消息partition对应的leader partition所在的broker主机
         */
        RecordAccumulator.ReadyCheckResult result = this.accumulator.ready(cluster, now);

        /**
         * 步骤三：标识信息partition没有对应leader partition的主题
         */
        ...
        /**
         * 步骤四：根据已获取的broker主机进行网络连通性测试，无法连通的进行移除处理
         */
        ...
        /**
         *步骤五：
         *      存在一些partition的leader partition在同一节点上并对其分组
         */
